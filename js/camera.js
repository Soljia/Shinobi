                            ...
                            switch (e.mon.type) {
                                ...
                                case 'local':
                                    ...
                                    e.spawn.stdout.on('data', function(data) {
                                        ...
                                        misc.tx({ f: 'monitor_snapshot', snapshot: data.toString('base64'), snapshot_format: 'b64', mid: e.mid, ke: e.ke }, 'GRP_' + e.ke)
                                        e.spawn.kill();
                                    });
                                        ...
                                        s.group[e.ke].mon[e.id].spawn.stderr.on('data', function(d) {
                                            ...
                                            switch (true) {
                                                ...
                                                case e.chk('Connection timed out'):
                                                    //restart
                                                    setTimeout(function() {
                                                        logging.log(e, { type: lang["Can't Connect"], msg: lang['Retrying...'] });
                                                        e.error_fatal();
                                                    }, 1000)
                                                    break;
