...
s.checkRegion = function(d, cord){
  ...
  s.group[d.ke][d.id].frameNumber = s.group[d.ke][d.id].frameNumber == 0 ? 1 : 0;
  ...
  for (b = 0; b < currentImageLength;){
    var pos = b * 4;
    s.group[d.ke][d.id].lastRegionImageData.data[pos] = 0.5 * (255 - s.group[d.ke][d.id].lastRegionImageData.data[pos]) + 0.5 * s.group[d.ke][d.id].frameSelected[s.group[d.ke][d.id].frameNumber].data[pos];
    s.group[d.ke][d.id].lastRegionImageData.data[pos + 1] = 0.5 * (255 - s.group[d.ke][d.id].lastRegionImageData.data[pos + 1]) + 0.5 * s.group[d.ke][d.id].frameSelected[s.group[d.ke][d.id].frameNumber].data[pos + 1];
    s.group[d.ke][d.id].lastRegionImageData.data[pos + 2] = 0.5 * (255 - s.group[d.ke][d.id].lastRegionImageData.data[pos + 2]) + 0.5 * s.group[d.ke][d.id].frameSelected[s.group[d.ke][d.id].frameNumber].data[pos + 2];
